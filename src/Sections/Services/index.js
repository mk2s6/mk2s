  ...
  return (
    <ServiceSection id="services">
      ...
      <Content ref={addToRefs}>
        <TextBlock
          topic="Design"
          title={<h1>We build award winning <br /> Applications</h1>}
          subText={
            <h5>
              We help clients to build simple and robust applications <br />
      ...
      <Content ref={addToRefs}>
        <TextBlock
          topic="Develop"
          title={<h1>We Develop high quality software</h1>}
          subText={
            <h5>
              We build appropriate solution to develop your websites & 
              applications with best tools available
            </h5>
          }
        />
        <OBJ>
